        ...
        <b-row>
            ...
            <b-col cols="12" sm="7 ml-9" class="mr-0 pr-0">
                ...
                <b-col class="mt-2" style="background: lightgrey; height:30vh;">
                    ...
                    <!-- <b-row  class="text-left pl-0 pr-1 " style="height:35vh;"
                             v-for="selected in $store.state.strategicObjectives.selected" :key="selected" >-->
                    <b-row class="mt-2">


                        <b-row v-for="selected in $store.state.strategicObjectives.selected"
                               :key="selected">


                            <!--<b-card-text v-for="list in lists"
                                         v-bind:key="list.id">
                                {{list.name}}
                                {{list.description}}
                            </b-card-text>-->

                            <b-row v-for="list in lists"
                                   v-bind:key="list.id">
                                <b-row v-if="list !== null && list.id === selected">
                                    <b-col cols="4">
                                        <h2>{{list.name}}</h2>
                                    </b-col>

                                    <!-- <b-col cols="7" class="mt-5 pt-5 ml-5">-->

                                    <b-row class="mt-1 pt-5">
                                        <b-col cols="4">
                                            <!--<img src="../assets/graph.png" height="155" width="217"/> -->
                                        </b-col>
                                        <b-col cols="7" class="ml-4 ">
                ...
                <!--<div v-if="list !== null && list.id === selected">-->
                <!--<h2>{{list.name}}</h2>
                <p> {{list.description}}</p>-->
                ...
                <b-col class="mt-5" style="background: lightgrey;">
                    ...
                    <b-row class="mt-4" style="height:275px;">
                        ...
                        <b-col class="text-left mr-1 mt-3" style="height:30vh;">
...
<script>
    ...
    export default {
        name: 'Dashboard',
        components: {  /*Treeselect,*/ AsyncTree,/*Scroll bar listings */vueCustomScrollbar, BPagination},
        data: () => {
        ...
        computed: {
            lists() {
                const items = this.$store.state.strategicObjectives.strategicObjectives
            ...
            totalRows() {
                return this.$store.state.strategicObjectives.selected.length
